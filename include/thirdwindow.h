...
protected:
  ...
  //Child widgets:
  Gtk::Grid m_point_grid_xy,m_point_grid_yz,m_point_grid_zx,m_edge_grid,m_face_grid,m_point_grid_buttons,m_input_grid;
  Gtk::Frame m_point_frame,m_edge_frame,m_face_frame,m_point_frame_xy,m_point_frame_yz,m_point_frame_zx,m_point_frame_buttons,m_input_frame;
