...
protected:
  ...
  //Child widgets:
  Gtk::Grid m_point_grid,m_edge_grid,m_face_grid,m_rotate_grid,m_create_grid,m_input_grid;
  Gtk::Frame m_point_frame,m_edge_frame,m_face_frame,m_rotate_frame,m_create_frame,m_input_frame;
  Gtk::Box m_Box;
